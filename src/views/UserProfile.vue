                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <p class="text-white mt-0 mb-5">This is your profile page.</p>
                            <!-- You can see the progress you've made with your work and manage your projects or assigned tasks -->
                            ...
                            <div class="col-lg-3 order-lg-2">
                                <div class="card-profile-image">
                                    <a href="#">
                                        ...
                                        <!-- <h1 class="rounded-circle">{{ initial }}</h1> --
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div slot="header" class="bg-white border-0">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex justify-content-around">
                                    <div class="col-1">
                                        <base-button size="sm" type="info" v-if="editing">Cancel</base-button>
                                    </div>
                                    <div class="col-1">
                                        <base-button size="sm" type="default" v-if="editing">Save</base-button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <base-input alternative=""
                                                        ...
                                                        v-model="model.username" editable="false"
                                            />
                                        </div>
                                        <div class="col-lg-6">
                                            <base-input alternative=""
...
<script>
  ...
  export default {
    ...
    computed: {
        ...
        initial(){
            return this.model.username.toUpperCase().substring(0,1);
        }
    }
  };
</script>
